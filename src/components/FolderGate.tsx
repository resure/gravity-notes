...
function Content({folder}: {folder: NotesFolder}) {
    ...
    return (
      <>
        ...
        <Text color="secondary">
          Gravity Notes stores notes as <code>.md</code> files using the File System Access API,
          which this browser doesn’t support. Please use a Chromium-based browser such as Chrome or
          Edge.
        </Text>
      </>
    );
  ...
  return (
    <>
      ...
      <Text color="secondary">
        Choose a folder on your computer to keep your notes. Each note is saved as a plain Markdown
        file you fully own.
      </Text>
      <div className="folder-gate__actions">
        <Button
